...
from pylab import step, show, ylim
...
# Helpers.
#
def histogram_step(prediction, measurement, correction):
...
def histogram_filter_step(belief, control, measurement):
    ...
    # Return both prediction and corrrection. This is for stepting only.
...
if __name__ == '__main__':
    ...
    for i in range(len(controls)):
        ...
        histogram_step(prediction, measurements[i], position)
