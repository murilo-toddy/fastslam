...
if __name__ == '__main__':
    ...
    for s in states:
        ...
        # print(s + [scanner_displacement * cos(s[2]), scanner_displacement * sin(s[2]), 0.0])
        res = s + [scanner_displacement * cos(s[2]), scanner_displacement * sin(s[2]), 0.0]
        f.write(f"F {res[0]} {res[1]} {res[2]}\n")
        # f.write(f"F %f %f %f\n" % {s + [scanner_displacement * cos(s[2]), scanner_displacement * sin(s[2]), 0.0]})
    f.close()
